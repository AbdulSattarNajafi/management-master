  ...
  return (
    ...
    >
      <div className="mb-3 flex w-full">
        ...
        />
        <div className="flex w-full items-center justify-between rounded-e-lg bg-gray-100 px-5 py-4 dark:bg-dark-secondary">
...
const Task = ({ task }: TaskProps) => {
  ...
  return (
    <div
      ...
      className={`mb-4 rounded-md shadow dark:bg-dark-secondary ${
